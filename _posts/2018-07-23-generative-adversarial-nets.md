...
![](/public/img/gan-figure1.JPG "Figure1 of Generative Adversarial Nets")
...
D와 G를 학습시키는 과정은 한 스텝씩 번갈아가며 파라미터를 업데이트하는 방식을 취합니다.
D를 업데이트 할 때는 G 파라미터를 고정한 상태고 G를 업데이트 할 때는 D 파라미터를 고정합니다.
