...
위 모델 그래프 구조에 따라 $\frac{\partial {o_j}}{\partial w_{1j}} = \frac{\partial {o_j}}{\partial {net}_j} \frac{\partial {net}_j}{\partial w_{1j}}$로 분할이 가능합니다.
$\frac{\partial {o_j}}{\partial {net}_j}$와 $\frac{\partial {net}_j}{\partial w_{1j}}$은 local gradient라고 불립니다.
